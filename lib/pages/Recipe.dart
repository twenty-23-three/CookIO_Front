              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                        title: Text('Шаг ${items.Description[index].StepNumber + 1}: ${items.Description[index].Step}'),
                      );
                    },
                  ),
                ),
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                        title: Text('${items.Products[index].ProductID + 1}: ${items.Products[index].Name} ${items.Products[index].Weight}гр.'),
                      );
                    },
                  ),
                ),
